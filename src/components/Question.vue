    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="col-xs-12 col-sm-6 text-center">
                <button class="btn btn-primary btn-lg" style="margin: 10px"
...
export default {
    ...
    methods:{
        generateQuestion(){
            ...
            const secoundNumber = this.generateRandomNumber(1,100);
            ...
            switch(modeNumber){
                case MODE_ADDITION: 
                    ...
                    this.question = `What's ${firstNumber} + ${secoundNumber} ?`;
                    break;
